...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-06-23 12:52:10 CST → 2026-06-24 12:55:56 CST |
| 📄 论文总数 | **6** 篇 |
...
> 💡 今日共收录 6 篇新论文，主要分布在 Speech LLM 1, TTS 1, Enhancement 1, Audio 3。
...
🔗 **来源**: [https://arxiv.org/abs/2606.24648v1](https://arxiv.org/abs/2606.24648v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音大模型」方向，核心任务由题目《ParaPairAudioBench: Paralinguistic Pairwise Audio Benchmark for LALM-as-a-Judge》所界定。 从摘要看，作者主要围绕 audio-language model 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our experiments show that current LALM judges still lag behind human judgments by 32%p on average and exhibit severe calibration failures, particularly in Tie cases where the correct decision is to abstain. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：audio-language model。 |
...
### 1. CN-NewsTTS Bench: a target-level automatic benchmark for raw-input Chinese news TTS pronunciation

👤 **作者**: Shijun Luo
🔗 **来源**: [https://arxiv.org/abs/2606.24714v1](https://arxiv.org/abs/2606.24714v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音合成」方向，核心任务由题目《CN-NewsTTS Bench: a target-level automatic benchmark for raw-input Chinese news TTS pronunciation》所界定。 从摘要看，作者主要围绕 text-to-speech、tts system 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：These forms are frequent in real listening workflows, and a text-to-speech (TTS) system can preserve the written string while changing the spoken meaning. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
🔗 **来源**: [https://arxiv.org/abs/2606.24745v1](https://arxiv.org/abs/2606.24745v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音增强」方向，核心任务由题目《Beyond U-Net: A Latent-Representation-Aligned Skip-Free Backbone for Flow-Matching Speech Enhancement》所界定。 从摘要看，作者主要围绕 speech enhancement 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Generative models, particularly diffusion and score-based approaches, have recently achieved strong performance in speech enhancement, but their iterative sampling process limits real-time deployment. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
### 1. SphereVBx: Spherical Variational Bayes Clustering for Simplified EEND-VC Diarization

👤 **作者**: Petr Pálka, Jiangyu Han, Prachi Singh, Marc Delcroix, Naohiro Tawara, Lukáš Burget
🔗 **来源**: [https://arxiv.org/abs/2606.24528v1](https://arxiv.org/abs/2606.24528v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《SphereVBx: Spherical Variational Bayes Clustering for Simplified EEND-VC Diarization》所界定。 从摘要看，作者主要围绕 spherevbx、spherical、variational 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Experiments on multiple diarization benchmarks show that SphereVBx improves clustering accuracy in cascaded diarization pipelines and achieves comparable or better performance in the EEND-VC framework while significantly simplifying its clustering stage. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：spherevbx, spherical, variational。 |
...
🔗 **来源**: [https://arxiv.org/abs/2606.24661v1](https://arxiv.org/abs/2606.24661v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Perceptual Evaluation of Higher-Order Ambisonic Codecs on Both Synthetic Mixing and Native Recordings》所界定。 从摘要看，作者主要围绕 perceptual、evaluation、higher-order 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Results show that IVAS outperforms the multi-mono approach at the same bitrate. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：perceptual, evaluation, higher-order。 |

---
### 3. A Methodology for Characterizing Underwater Radiated Noise from Submerged Electric Vehicles in a Coastal Environment: An AUV Test Case

👤 **作者**: Mark Shipton, Amir Boag, Roee Diamant
🔗 **来源**: [https://arxiv.org/abs/2606.24813v1](https://arxiv.org/abs/2606.24813v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《A Methodology for Characterizing Underwater Radiated Noise from Submerged Electric Vehicles in a Coastal Environment: An AUV Test Case》所界定。 从摘要看，作者主要围绕 methodology、characterizing、underwater 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The methodology is demonstrated using an A18D AUV measured in coastal water. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：methodology, characterizing, underwater。 |
