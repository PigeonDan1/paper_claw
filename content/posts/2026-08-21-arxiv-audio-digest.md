...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-08-18 10:06:44 CST → 2026-08-21 10:14:31 CST |
| 📄 论文总数 | **27** 篇 |
...
> 💡 今日共收录 27 篇新论文，主要分布在 ASR 4, TTS 1, Paralinguistics 1, Audio 21。
...
🔗 **来源**: [https://arxiv.org/abs/2608.17931v1](https://arxiv.org/abs/2608.17931v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《SpeechSense: A Paralinguistic-Focused Dataset for Fine-Grained Speech Sentiment Analysis》所界定。 从摘要看，作者主要围绕 speech understanding、automatic speech recognition、speech synthesis 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Comprehensive experiments across multi-modal LLMs, text-only LLMs, and speech encoders demonstrate that models with acoustic access consistently outperform text-only baselines. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：speech understanding, automatic speech recognition, speech synthesis。 |
...
🔗 **来源**: [https://arxiv.org/abs/2608.18825v1](https://arxiv.org/abs/2608.18825v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Understanding Multilingual Medical ASR Adaptation Through Layer-Wise Analysis》所界定。 从摘要看，作者主要围绕 automatic speech recognition、whisper 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Although large-scale pretrained ASR models such as Whisper achieve strong generalisation, their behaviour after medical and multilingual adaptation remains insufficiently understood beyond word error rate (WER). 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：automatic speech recognition, whisper。 |

---
### 3. A Speech Corpus for Mizo Automatic Speech Recognition: Whisper and SraVaani 1.0 Fine-Tuning with Morphology-Aware Evaluation

👤 **作者**: Priyankoo Sarmah, Sanasam Ranbir Singh, Lalhmingmawia
🔗 **来源**: [https://arxiv.org/abs/2608.19361v1](https://arxiv.org/abs/2608.19361v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《A Speech Corpus for Mizo Automatic Speech Recognition: Whisper and SraVaani 1.0 Fine-Tuning with Morphology-Aware Evaluation》所界定。 从摘要看，作者主要围绕 automatic speech recognition、asr system、whisper 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Whisper-large-v3 achieved the lowest conventional WER (18.08%), while morphology-aware evaluation yielded a WER of 7.22%. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：automatic speech recognition, asr system, whisper。 |
...
🔗 **来源**: [https://arxiv.org/abs/2608.19936v1](https://arxiv.org/abs/2608.19936v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音识别」方向，核心任务由题目《Towards Quantifying Benchmark Optimization in ASR Models》所界定。 从摘要看，作者主要围绕 automatic speech recognition 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Using a variety of mechanistic probes, we show that models respond to narrow acoustic cues to override the faithful representation of the audio in favor of a benchmark-optimized policy. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：automatic speech recognition。 |

---
## 🏷️ TTS

### 1. Tracking the Trend in How Speech Synthesizers Deceive People

👤 **作者**: Milan Šalko, Anton Firc, Kamil Malinka, Vojtěch Staněk, Martin Perešini, Filip Pleško, Jakub Reš
🔗 **来源**: [https://arxiv.org/abs/2608.19959v1](https://arxiv.org/abs/2608.19959v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「语音合成」方向，核心任务由题目《Tracking the Trend in How Speech Synthesizers Deceive People》所界定。 从摘要看，作者主要围绕 speech synthesis、voice synthesis 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：These findings show that human perception alone is unreliable for the selected modern and partial-spoof conditions and motivate procedural verification, provenance, watermarking, and segment-level detection. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：speech synthesis, voice synthesis。 |
...
### 1. Target Speaker Identification: A Low-Latency Streaming Pipeline

👤 **作者**: Patrick S. Burke, Satyam Raj, Sean Kinahan
🔗 **来源**: [https://arxiv.org/abs/2608.17972v1](https://arxiv.org/abs/2608.17972v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「副语言学」方向，核心任务由题目《Target Speaker Identification: A Low-Latency Streaming Pipeline》所界定。 从摘要看，作者主要围绕 speaker verification、speaker identification 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Across 17 evaluation episodes, the system achieves greater than 0.90 median accuracy with high specificity (0.95-0.98) at cosine distance thresholds of 0.7-0.75, demonstrating a practical proof of concept for downstream low-latency selective amplification. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：speaker verification, speaker identification。 |

---
## 🏷️ Audio

### 1. Multi-turn Conversational AI from Text to Multimodal Interaction: Data, Models, Evaluation, and Open Challenges

👤 **作者**: Syeda Faiza Ahmed, Zien Sheikh Ali, Hunzalah Hassan Bhatti, Firoj Alam, Shammur Absar Chowdhury
🔗 **来源**: [https://arxiv.org/abs/2608.17605v1](https://arxiv.org/abs/2608.17605v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Multi-turn Conversational AI from Text to Multimodal Interaction: Data, Models, Evaluation, and Open Challenges》所界定。 从摘要看，作者主要围绕 multi-turn、conversational、from 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our analysis shows that support for multiple modalities has advanced faster than the ability to sustain coherent interaction across a session. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：multi-turn, conversational, from。 |
...
🔗 **来源**: [https://arxiv.org/abs/2608.18191v1](https://arxiv.org/abs/2608.18191v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《ChiroEcho: extending automated bat vocalisation classification beyond the learned taxonomy》所界定。 从摘要看，作者主要围绕 chiroecho、extending、automated 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The rare-species analysis shows how limited evaluation data can obscure species-level performance, while the held-out experiment shows that genus predictions and location can recover labels unavailable to the species head. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：chiroecho, extending, automated。 |

---
### 3. UniVerse: Benchmarking and Enhancing LALMs on Culturally Inclusive Low-Resource Music Understanding
...
🔗 **来源**: [https://arxiv.org/abs/2608.17852v1](https://arxiv.org/abs/2608.17852v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《UniVerse: Benchmarking and Enhancing LALMs on Culturally Inclusive Low-Resource Music Understanding》所界定。 从摘要看，作者主要围绕 audio-language model、sound event detection 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Recent advances in large audio-language models (LALMs) have significantly improved performance in tasks such as music captioning, genre classification, and sound event detection. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
...
👤 **作者**: Yi Wang
🔗 **来源**: [https://arxiv.org/abs/2608.18025v1](https://arxiv.org/abs/2608.18025v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Why GPT-Style Models Do Not Directly Transfer to Symbolic Music: Compression in the Wrong Coordinate System》所界定。 从摘要看，作者主要围绕 gpt-style、models、directly 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：GPT-style models achieve strong performance by representing language with finite vocabularies of reusable discrete tokens. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：gpt-style, models, directly。 |

---
### 5. FM Synthesizer Audio-Parameter Shared Embeddings

👤 **作者**: David Braun, Adam Finkelstein
🔗 **来源**: [https://arxiv.org/abs/2608.18226v1](https://arxiv.org/abs/2608.18226v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《FM Synthesizer Audio-Parameter Shared Embeddings》所界定。 从摘要看，作者主要围绕 synthesizer、audio-parameter、shared 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：When every topology is seen during training, the DX7-GNN and two baselines achieve strong audio-to-preset retrieval. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：synthesizer, audio-parameter, shared。 |

---
### 6. Low-Power, Neuromorphic, Acoustic Anomaly Detection for Persistent Machine Monitoring

👤 **作者**: Steven C. Nesbit, Victor M. Vergara, Michael A. Felix, Evan T. Kain, Luis R. García Carrillo, Gerd J. Kunde, Andrew T. Sornborger
🔗 **来源**: [https://arxiv.org/abs/2608.18341v1](https://arxiv.org/abs/2608.18341v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Low-Power, Neuromorphic, Acoustic Anomaly Detection for Persistent Machine Monitoring》所界定。 从摘要看，作者主要围绕 low-power、neuromorphic、acoustic 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We demonstrate autoencoder-based acoustic anomaly detection on an Intel Loihi 2 neuromorphic processor under clean and noisy conditions. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：low-power, neuromorphic, acoustic。 |

---
### 7. Sounds Uncertain: Exploring the Affective Aspects of Sonification for Uncertainty Visualization

👤 **作者**: Marcel-Simon Dutt, Sita A. Vriend, Elias Elmquist, Daniel Weiskopf
🔗 **来源**: [https://arxiv.org/abs/2608.18680v1](https://arxiv.org/abs/2608.18680v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Sounds Uncertain: Exploring the Affective Aspects of Sonification for Uncertainty Visualization》所界定。 从摘要看，作者主要围绕 sounds、uncertain、exploring 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our findings show that uncertainty was commonly associated with wavy auditory qualities related to an ominous sentiment. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：sounds, uncertain, exploring。 |

---
### 8. Generalized Audio-Driven Synthesis of Precise Drummer Motion

👤 **作者**: Álvaro G. Iñesta, Mattia Ryffel, Amit H. Bermano, Robert W. Sumner, Martin Guay
🔗 **来源**: [https://arxiv.org/abs/2608.19055v1](https://arxiv.org/abs/2608.19055v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Generalized Audio-Driven Synthesis of Precise Drummer Motion》所界定。 从摘要看，作者主要围绕 generalized、audio-driven、synthesis 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Our quantitative analysis and user studies demonstrate that our system generates high-quality motion that is often indistinguishable from ground-truth performances. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：generalized, audio-driven, synthesis。 |

---
### 9. Computational Features for Symbolic Melody Analysis

👤 **作者**: David M. Whyatt, Peter M. C. Harrison
🔗 **来源**: [https://arxiv.org/abs/2608.19061v1](https://arxiv.org/abs/2608.19061v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Computational Features for Symbolic Melody Analysis》所界定。 从摘要看，作者主要围绕 music information retrieval 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We then demonstrate the combined feature set on the Essen Folksong Collection, using the dataset to produce a series of style classification models. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：music information retrieval。 |

---
### 10. Does Mapping Non-Maximal Probabilities to GMM Components Matter for S-JEPA Encoder Representations?

👤 **作者**: Wenxuan He, Yunpeng Li, Shan Liang
🔗 **来源**: [https://arxiv.org/abs/2608.19084v1](https://arxiv.org/abs/2608.19084v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Does Mapping Non-Maximal Probabilities to GMM Components Matter for S-JEPA Encoder Representations?》所界定。 从摘要看，作者主要围绕 does、mapping、non-maximal 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Across three independent seeds, REAL SOFT outperforms both controls on two frozen Encoder readouts. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：does, mapping, non-maximal。 |

---
### 11. Geometric Iterative Retrieval for Neural Audio Codec Resynthesis

👤 **作者**: Leo Schmidt-Traub, Frédéric Berdoz, Luca A. Lanzendörfer, Roger Wattenhofer
🔗 **来源**: [https://arxiv.org/abs/2608.19141v1](https://arxiv.org/abs/2608.19141v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Geometric Iterative Retrieval for Neural Audio Codec Resynthesis》所界定。 从摘要看，作者主要围绕 audio generation 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We evaluate our method on codec restoration tasks across speech and music, and show improvements over both single-pass token prediction and one-step regression baselines. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：audio generation。 |

---
### 12. Finetuning Strategies for Querying Sounds by Vocal Imitation

👤 **作者**: Aditya Bhattacharjee, Christos Plachouras, Sungkyun Chang, Emmanouil Benetos
🔗 **来源**: [https://arxiv.org/abs/2608.19174v1](https://arxiv.org/abs/2608.19174v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Finetuning Strategies for Querying Sounds by Vocal Imitation》所界定。 从摘要看，作者主要围绕 finetuning、strategies、querying 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We investigate two complementary fine-tuning strategies: contrastive learning with a frozen, pretrained CED encoder, and joint contrastive-triplet learning with semi-hard negatives using a MobileNetV3 encoder. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：finetuning, strategies, querying。 |

---
### 13. MultiVerse: A Creator-Centered Approach to Steering Context-Adaptive Lyrics

👤 **作者**: Alexander Wang, Chris Donahue, David Lindlbauer
🔗 **来源**: [https://arxiv.org/abs/2608.19350v1](https://arxiv.org/abs/2608.19350v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《MultiVerse: A Creator-Centered Approach to Steering Context-Adaptive Lyrics》所界定。 从摘要看，作者主要围绕 multiverse、creator-centered、approach 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：For instance, AI systems could adapt song lyrics to the listener and their current activity. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：multiverse, creator-centered, approach。 |

---
### 14. DAVSS: Distilled Audio-Visual State Space Models

👤 **作者**: Saurabhchand Bhati, Mrudula Athi, Amit S. Chhetri, James Glass
🔗 **来源**: [https://arxiv.org/abs/2608.19523v1](https://arxiv.org/abs/2608.19523v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《DAVSS: Distilled Audio-Visual State Space Models》所界定。 从摘要看，作者主要围绕 davss、distilled、audio-visual 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The DAVSS model, 14M parameters, is 12 times smaller compared to transformer-based models such as CAV-MAE, and still outperforms them. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：davss, distilled, audio-visual。 |
...
🔗 **来源**: [https://arxiv.org/abs/2608.19527v1](https://arxiv.org/abs/2608.19527v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Does Listening Matter? Backchanneling and Nodding in AI Clone》所界定。 从摘要看，作者主要围绕 does、listening、matter 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：In a within-subjects study (N=35), adding these behaviors significantly improved the perceived attentiveness of the avatar, the sense of talking with the real person, and the feeling of co-presence. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：does, listening, matter。 |

---
### 16. Dancing Through Soundscapes: Designing a Low-Cost, Sound-Based Device for Sensing and Interpreting Movement and Dance

👤 **作者**: Swen E. Gaudl, Silvia Carderelli-Gronau
🔗 **来源**: [https://arxiv.org/abs/2608.19827v1](https://arxiv.org/abs/2608.19827v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Dancing Through Soundscapes: Designing a Low-Cost, Sound-Based Device for Sensing and Interpreting Movement and Dance》所界定。 从摘要看，作者主要围绕 dancing、through、soundscapes 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：The paper further reflects on observations from workshops and public sharings, including how participants used repetition, stillness, environmental sound, and call-and-response to understand and improvise with the soundscape. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：dancing, through, soundscapes。 |

---
### 17. Fourier is Frontier: Frequency-Aware Autoencoding for High-Fidelity Music Reconstruction

👤 **作者**: Kangdi Wang, Yusheng Dai, Jin Xu
🔗 **来源**: [https://arxiv.org/abs/2608.19843v1](https://arxiv.org/abs/2608.19843v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Fourier is Frontier: Frequency-Aware Autoencoding for High-Fidelity Music Reconstruction》所界定。 从摘要看，作者主要围绕 fourier、frontier、frequency-aware 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Among five matched-budget representations, the complex STFT achieves the lowest full-band and high-frequency spectral distances, providing direct access to magnitude and phase at every bin. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：fourier, frontier, frequency-aware。 |
...
🔗 **来源**: [https://arxiv.org/abs/2608.19863v1](https://arxiv.org/abs/2608.19863v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Listening Forward: Next Patch Embedding Prediction Enables Scalable Audio Learners》所界定。 从摘要看，作者主要围绕 listening、forward、next 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Across six audio and speech benchmarks, NAPE achieves state-of-the-art fine-tuning performance on several tasks, scales consistently across encoder sizes, and yields strong linear-probing results. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：listening, forward, next。 |

---
### 19. Unified Music Identification for Tracks and Versions

👤 **作者**: R. Oguz Araz, Joan Serrà, Yuki Mitsufuji, Xavier Serra, Dmitry Bogdanov
🔗 **来源**: [https://arxiv.org/abs/2608.19919v1](https://arxiv.org/abs/2608.19919v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Unified Music Identification for Tracks and Versions》所界定。 从摘要看，作者主要围绕 unified、music、identification 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Comparing seven existing models on this benchmark, we show that none of them are both accurate and robust on both tasks. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：unified, music, identification。 |

---
### 20. Explainability by Design: Structured Kolmogorov-Arnold Networks over Probabilistic Attributes for Speech Deepfake Source Tracing

👤 **作者**: Hoang H. Pham, Manasi Chhibber, Tomi H. Kinnunen
🔗 **来源**: [https://arxiv.org/abs/2608.20213v1](https://arxiv.org/abs/2608.20213v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Explainability by Design: Structured Kolmogorov-Arnold Networks over Probabilistic Attributes for Speech Deepfake Source Tracing》所界定。 从摘要看，作者主要围绕 explainability、design、structured 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：On ASVspoof2019-attr-17, the extended framework achieves balanced accuracies above 99% for all seven probabilistic feature extractors, with EERs of 0.16% to 0.07%, and 99.64% balanced accuracy with 0.11% EER for 17-class attack classification. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性偏低。缩写、设定或实验细节较多，首次浏览成本偏高。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：explainability, design, structured。 |

---
### 21. $TCP_α$: Margin-Controlled Confidence estimation for reliable Music Information Retrieval

👤 **作者**: Parampreet Singh, Anushka Singh, Sumit Kumar, Vipul Arora
🔗 **来源**: [https://arxiv.org/abs/2608.20326v1](https://arxiv.org/abs/2608.20326v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《$TCP_α$: Margin-Controlled Confidence estimation for reliable Music Information Retrieval》所界定。 从摘要看，作者主要围绕 music information retrieval 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Across all settings, $TCP_α$ consistently outperforms existing confidence targets for failure prediction. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
