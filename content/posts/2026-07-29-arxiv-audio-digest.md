...
| 指标 | 数值 |
|:---|:---|
| ⏰ 时间窗口 | 2026-07-28 11:52:41 CST → 2026-07-29 11:56:33 CST |
| 📄 论文总数 | **7** 篇 |
...
### 1. GraphIDyOM: A graph-native Python reimplementation of IDyOM for musical expectation modelling

👤 **作者**: Lluc Bono Rosselló
🔗 **来源**: [https://arxiv.org/abs/2607.25787v1](https://arxiv.org/abs/2607.25787v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《GraphIDyOM: A graph-native Python reimplementation of IDyOM for musical expectation modelling》所界定。 从摘要看，作者主要围绕 graphidyom、graph-native、python 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We then demonstrate how the explicit memory representation supports network analysis of learned memories, projection of expectation values onto musical networks, recency-sensitive memory retrieval, and interactive applications. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：graphidyom, graph-native, python。 |

---
### 2. VAD to the Bone: Ultra-Tiny Speech Activity Detection for Edge Deployment

👤 **作者**: Stephen Bauer, Sheila Seidel, Shanza Iftikhar, Scott Veidenheimer, Gorkem Ulkar
🔗 **来源**: [https://arxiv.org/abs/2607.25870v1](https://arxiv.org/abs/2607.25870v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《VAD to the Bone: Ultra-Tiny Speech Activity Detection for Edge Deployment》所界定。 从摘要看，作者主要围绕 bone、ultra-tiny、speech 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：We introduce per-layer structured pruning with self-distillation and angle-based quantization-aware training (QAT) that outperforms standard QAT by 1-4%. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：bone, ultra-tiny, speech。 |

---
### 3. Device Invariance using Domain Adaptation on Acoustic Scene Classification

👤 **作者**: Abhishek dileep, Shubham Sharma, Padmanabhan Rajan
🔗 **来源**: [https://arxiv.org/abs/2607.25887v1](https://arxiv.org/abs/2607.25887v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Device Invariance using Domain Adaptation on Acoustic Scene Classification》所界定。 从摘要看，作者主要围绕 acoustic scene 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Two well-known domain adaptation techniques, namely domain adversarial neural network (also called DANN) and conditional domain adversarial network (also called CDAN) are evaluated under various domain shifts. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：acoustic scene。 |

---
### 4. Depression Markers in Speech: An Approach based on Tract Variables Dynamics

👤 **作者**: Sahar Altalhi, Tanaya Guha, Alessandro Vinciarelli
🔗 **来源**: [https://arxiv.org/abs/2607.25888v1](https://arxiv.org/abs/2607.25888v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Depression Markers in Speech: An Approach based on Tract Variables Dynamics》所界定。 从摘要看，作者主要围绕 depression、markers、speech 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：A key advantage of this approach lies in its ability to quantify aspects of the articulatory process that have not been previously explored in the context of depression, namely predictability, complexity, and randomness. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性高。摘要结构较直白，问题、方法和结果都比较容易定位。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：depression, markers, speech。 |
...
🔗 **来源**: [https://arxiv.org/abs/2607.25903v1](https://arxiv.org/abs/2607.25903v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《CARE: A Multimodal Corpus for Studying Speech and Non-Verbal Communication Across Multiple Medical Conditions》所界定。 从摘要看，作者主要围绕 care、multimodal、corpus 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Automatic analysis of multimodal speech has shown strong potential for computationally detecting and monitoring a wide range of neurological, psychiatric, and respiratory conditions. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：care, multimodal, corpus。 |

---
### 6. Spacing Out: On the Reliability of Binaural Music Source Separation Metrics

👤 **作者**: Richa Namballa, Magdalena Fuentes
🔗 **来源**: [https://arxiv.org/abs/2607.25919v1](https://arxiv.org/abs/2607.25919v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《Spacing Out: On the Reliability of Binaural Music Source Separation Metrics》所界定。 从摘要看，作者主要围绕 source separation、music information retrieval 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：While existing stereo MSS models can process binaural audio, they often degrade the spatial quality of the separated stems and undermine listener immersion. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要更偏方法描述，建议点开原文确认实验细节。 优先看这些信号词：source separation, music information retrieval。 |

---
### 7. LLM4OSC: Profile-Bound Natural Language Control with Deterministic Validation for Open Sound Control

👤 **作者**: Yuan-Yi Fan
🔗 **来源**: [https://arxiv.org/abs/2607.26024v1](https://arxiv.org/abs/2607.26024v1)
...
| 项目 | 内容 |
|:---|:---|
| 📝 总结 | 这篇工作归入「通用音频」方向，核心任务由题目《LLM4OSC: Profile-Bound Natural Language Control with Deterministic Validation for Open Sound Control》所界定。 从摘要看，作者主要围绕 profile-bound、natural、language 展开方法设计、训练策略或系统建模。 结果部分最值得注意的是：Large language models can emit plausible OSC, but they hallucinate addresses, mishandle type tags, and fail under paraphrase- unacceptable in show-critical contexts. 如果你想快速判断这篇论文是否值得细读，这份摘要已经能帮助你抓住问题、方法和结果主线。 |
| 📖 可读性 | 可读性中。需要一定领域背景，但主线仍然清楚。 摘要中给出了明确指标，适合快速判断效果。 优先看这些信号词：profile-bound, natural, language。 |
